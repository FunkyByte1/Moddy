...
echo "  gh release delete nightly --repo FunkyByte1/Moddy --yes --cleanup-tag || true"
echo "  gh release create nightly \\"
echo "    ${OUT_DIR}/${ZIP_NAME} ${OUT_DIR}/moddy-nightly.zip \\"
echo "    --repo FunkyByte1/Moddy --title \"Nightly\" --prerelease"
echo ""
echo "Decky install link (constant — always the latest nightly):"
echo "  https://github.com/FunkyByte1/Moddy/releases/download/nightly/moddy-nightly.zip"