...
# A hard crash mid-commit can leave one behind — the startup sweep (added with the fan-out)
# removes orphans, since a `*.moddy-bak` next to its live original is always disposable.
