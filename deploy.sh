...
scp backend/registry.py backend/steam.py backend/modloaders.py backend/mods.py backend/profiles.py backend/github.py backend/utils.py "$DECK:$TMP/backend/"
